...
import {
  buildRegieListMembershipStandardFlatFieldMetadatas,
  buildRegieStaticListStandardFlatFieldMetadatas,
  buildRegieSyncSourceStandardFlatFieldMetadatas,
} from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-regie-standard-flat-field-metadata.util';
...
const STANDARD_FLAT_FIELD_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  regieStaticList: buildRegieStaticListStandardFlatFieldMetadatas,
  regieListMembership: buildRegieListMembershipStandardFlatFieldMetadatas,
  regieSyncSource: buildRegieSyncSourceStandardFlatFieldMetadatas,
