...
>): Record<AllStandardObjectFieldName<'company'>, FlatFieldMetadata> => ({
  ...
  regieListMemberships: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'regieListMemberships',
      label: 'Regie List Memberships',
      description: 'Regie list memberships for this company',
      icon: 'IconList',
      isNullable: true,
  ...
  regieSyncSources: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'regieSyncSources',
      label: 'CRM Sync Sources',
      description: 'CRM source records associated with this company',
      icon: 'IconRefresh',
      isNullable: true,
      targetObjectName: 'regieSyncSource',
      targetFieldName: 'company',
      settings: { relationType: RelationType.ONE_TO_MANY },
    },
    standardObjectMetadataRelatedEntityIds,
