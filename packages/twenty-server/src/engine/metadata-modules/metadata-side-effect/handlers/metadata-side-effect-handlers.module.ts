...
import { FieldPhoneSearchOnCreateSideEffectHandlerService } from 'src/engine/metadata-modules/metadata-side-effect/handlers/field-metadata/services/field-phone-search-on-create-side-effect-handler.service';
import { FieldPhoneSearchOnUpdateSideEffectHandlerService } from 'src/engine/metadata-modules/metadata-side-effect/handlers/field-metadata/services/field-phone-search-on-update-side-effect-handler.service';
...
@Module({
  providers: [
    ...
    FieldPhoneSearchOnCreateSideEffectHandlerService,
    FieldPhoneSearchOnUpdateSideEffectHandlerService,
