...
describe('WorkspaceDeletionPhaseOperationsService final core-row deletion deadline', () => {
  it('uses the bounded maintenance transaction so a client timeout cannot leave an ambiguous commit', async () => {
    ...
    Reflect.set(service, 'maintenance', maintenance);
    ...
    await service.deleteCoreRow('20202020-0000-4000-8000-000000000001');
