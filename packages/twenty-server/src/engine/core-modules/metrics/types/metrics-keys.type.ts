export enum MetricsKeys {
  ...
  WorkspaceDeletionCompleted = 'workspace-deletion/completed',
  WorkspaceDeletionFailed = 'workspace-deletion/failed',
  WorkspaceDeletionDiscoveryFailed = 'workspace-deletion/discovery-failed',
  WorkspaceDeletionDiscoveryCandidates = 'workspace-deletion/discovery-candidates',
  WorkspaceDeletionAdmitted = 'workspace-deletion/admitted',
  WorkspaceDeletionRecovered = 'workspace-deletion/recovered',
  WorkspaceDeletionPhaseDurationMs = 'workspace-deletion/phase-duration-ms',
